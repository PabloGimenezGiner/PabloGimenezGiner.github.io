...
import { updateCamera, setInputManager } from './camera/cameraPhysics.js';  // ← eliminado project3D
...
// 2. Cargar partida guardada (si existe)
const loaded = loadGame();

// 3. Generar chunks alrededor de la posición inicial de la cámara
...
function loop(now) {
  ...
  // ---- PROCESAR EVENTOS DE INPUT (toggles y potencia) ----
